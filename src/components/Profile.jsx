				...
				{this.state.profileRoute === "details" ? (
					<div className="profile-container">
						<div className="form-header">
							...
							<div
								className="close"
								onClick={(e) => this.props.profileControl("hidden")}>
								x
							</div>
						</div>
						...
						<div className="profile-info">
							...
							this.props.user.email === "employee" ? (
								<div>
									<p style={{ margin: "5px 0", color: "rgb(61, 198, 225)" }}>
										Cannot Edit
									</p>
								</div>
							) : (
								<div>
									<p
										...
										onClick={() =>
											this.setState({ profileRoute: "editDetails" })
										}>
									...
									<p
										className="profile-edit"
										onClick={() =>
											this.setState({ profileRoute: "editPassword" })
										}>
					...
					<div className="profile-container">
						...
						<div className="profile-info">
							...
							<input
								...
								onChange={(e) => this.userChange(e, "phone")}
							/>
						</div>
						<div className="profile-info">
							<h2>Email:</h2>
						...
						<div className="profile-info">
							<div className="btn" onClick={() => this.profileSubmit()}>
								Submit
							</div>
						</div>
					</div>
					...
					<div className="profile-container">
						...
						<div className="profile-info">
							<div className="btn" onClick={() => this.changePassword()}>
								Submit
							</div>
						</div>
					</div>
