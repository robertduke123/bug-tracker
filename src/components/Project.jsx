	...
	return (
		<div>
			{projects.map((project) => {
				if (project.name === props.loadedProject.name) {
					return (
							...
							<div className="project-main">
								<div className="team-container">
									<div className="team-head">
										...
										<div
											className="btn"
											onClick={(e) => props.newFormControl(e, "member", false)}>
											New Member
										</div>
									</div>
												...
												if (
													...
													return (
														<li
															...
															<ul
																className="edit-container closing"
																id="mem-edit">
																<li
																	onClick={(e) =>
																		props.deleteItem(e, "member")
																	}>
																	delete
																</li>
															</ul>
								...
								<div className="tickets-container">
									<div className="ticket-head">
										...
										<div
											className="btn"
											onClick={(e) => props.newFormControl(e, "ticket")}>
											New Ticket
										</div>
									</div>
												...
												return (
													<li
														...
														<ul className="edit-container closing">
															<li
																onClick={(e) =>
																	props.newFormControl(e, "ticket", edit)
																}>
																edit
															</li>
															<li
																onMouseDown={(e) => allColor(e)}
																onMouseUp={(e) =>
																	props.deleteItem(e, "ticket")
																}>
																delete
															</li>
														</ul>
								...
								<div className="ticket-info-container">
									...
									<div className="ticket-info">
										...
										<div className="ticket-comment">
											...
											<div
												className="submit"
												onClick={(e) => props.commentAction(e, "add")}>
												Comment
											</div>
										</div>
									</div>
